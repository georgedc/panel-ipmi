...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h1 class="h3 mb-1"><?php echo htmlspecialchars(__('mvc.users_assign_title')); ?></h1>
        <p class="text-muted mb-0"><?php echo htmlspecialchars(__('mvc.users_assign_subtitle', ['user' => (string) ($user['username'] ?? '')])); ?></p>
    </div>
