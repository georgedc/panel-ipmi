var kbdUtil = (function() {
    ...
    function isIE11(evt){
         //workaround solution: IE11 sends key events different from IE10, so we do this...
         return (evt.key === 'Add' || evt.key === 'Multiply') ? true : false;
    }
    ...
    function getKeysym(evt){
        ...
        else if (evt.char && evt.char.length === 1) {
    ...
    function nonCharacterKey(evt) {
        ...
        switch (keycode) {
            ...
            case 106 : return XK_KP_Multiply;
            case 107 : return XK_KP_Add;
            default: return null;
        }
    }
    return {
