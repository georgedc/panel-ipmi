...
function Websock() {
    ...
    this._rQmax = 100000;     // Max receive queue size before compacting
    this._sQ = [];           // Send queue
    ...
    Websock.prototype = {
        ...
        open: function (uri, protocols) {
            ...
            this._websocket.onopen = (function () {
                ...
                if (uri.search('websockify') < 0) {
                    this._mode = 'binary';
                    Util.Info("Server choose non-websockify");
                } else if (this._websocket.protocol) {
